...
| PHP 7.0 | **incompatible** | compatible and **recommended** |
| PHP 5.6 | compatible and **recommended** | compatible and **recommended** |
| PHP 5.5 | compatible, but **not recommended** due to to [PHP end-of life](http://php.net/eol.php) in July 2016 | compatible, but **not recommended** due to to [PHP end-of life](http://php.net/eol.php) in July 2016 |
| PHP 5.4 | compatible but **not recommended** due to to [PHP end-of life](http://php.net/eol.php) in Sept 2015 | **deprecated** [as of March, 2018](https://civicrm.org/blog/totten/end-of-zombies-php-53-and-54) |
| PHP 5.3 | compatible but **not recommended** due to to [PHP end-of life](http://php.net/eol.php) in August 2014 | **deprecated** [as of December, 2017](https://civicrm.org/blog/totten/end-of-zombies-php-53-and-54) |
