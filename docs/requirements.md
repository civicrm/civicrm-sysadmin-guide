...
| -- | -- | -- |
| PHP 7.3 | testing incomplete but preliminary testing did not find any issues | testing incomplete but preliminary testing did not find any issues | compatible and **recommended** |
